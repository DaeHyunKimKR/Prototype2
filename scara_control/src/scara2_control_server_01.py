        ...
        while True:
            ...
            if cmd == "joint":
                try:
                    ...
                    print("[SCARA::CMD] set target joint")
                except:
                ...
                try:
                    ...
                    SS.pub_scara_cmd(node, cmd, dist1, ang1, ang2, ang3)
                    print("[SCARA::CMD] set target velocity")
                except:
                    print("[SCARA::WARN] INVALID INPUT error1")
                ...
                try:
                    ...
                    if (type(t_temp) is int) or (type(t_temp) is float):
                        ...
                        print("[SCARA::CMD] set target joint with time (1)")
                    elif type(t_temp) is list:
                        print('CP 2')
                        SS.pub_scara_cmd(node, cmd, dist1, ang1, ang2, ang3, 0, t_temp, 0)
                        print("[SCARA::CMD] set target joint with time (2)")
                except:
                    print("[SCARA::WARN] INVALID INPUT error1")
