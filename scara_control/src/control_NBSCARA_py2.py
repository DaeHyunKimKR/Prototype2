...
class NBSCARA:
    def __init__(self, port, home_pulse = [], limit_pos1 = [], limit_pos2 = []):
        self.__port = port
        ...
        self.__limit_pulse1 = limit_pos1
        self.__limit_pulse2 = limit_pos2
        
        self.__list_j_id = [ 1, 2, 3, 4]
        self.__list_c_id = [ 4, 1, 2, 3]
        
        self.__joint = {}
        self.__joint[self.__list_j_id[0]] = module_JSD_B7(device_id=self.__list_c_id[0], pulse_per_rotation=2**17, gear_ratio=18/15, pitch=5, home_pulse=home_pulse[0], direction = -1)
